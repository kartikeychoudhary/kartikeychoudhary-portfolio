...
// -----------------------------------------------------------------------------
//  Edit every piece of on-screen content here. Toggle sections on/off with
//  `enabled`. Point `assets.*` to files you drop into /public/assets. Choose
//  how the contact form submits via `form.submission.type`.
//
//  The build uses environment.production.js when you run `npm run build`.
// =============================================================================

export const ENV_NAME = "development";

export const site = {
  title: "Kartikey Choudhary — Senior Software Engineer (dev)",
  accent: "teal",
  texture: "grid",
  heroVariant: "split",
